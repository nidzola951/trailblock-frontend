...
export default class Register extends React.Component {
  ...
  handleDataSubmit = e => {
    ...
    if (
      ...
      this.props.actions.signUp(this.state.email.toLocaleLowerCase(), this.state.password);
    }
  };
  render() {
    return (
                ...
                <Col md={12}>
                  ...
                  {this.props.auth.hasSignedUp === 'AUTH_SUCCESS' && (
                    <Alert type="success">
                      ...
                      We sent you an e-mail with verification code. Please,{' '}
                      <ActionButtonSuccess to="verify-account">
                        head over to verification page and enter it there.
                      </ActionButtonSuccess>
                    </Alert>
                  )}
